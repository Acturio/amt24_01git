...
Antes de comenzar, hay que conocer el concepto de __área de preparación de Git__ que presentaremos ahora.  
El __área de preparación de Git__, también conocida como __"index"__ o __"staging area"__, es donde se preparan los cambios antes de confirmarlos con un commit. Permite seleccionar qué modificaciones se incluirán en el próximo commit y facilita la revisión y organización de los cambios antes de su confirmación definitiva en el historial del repositorio.
