...
```{bash eval=F}
*   7e666cc - (hace 3 minutos) incorporacion de Nova y Spider-Gwen (T-65) al registro principal - Byron Ornelas (HEAD -> main)
|\  
| * edf50e5 - (hace 2 semanas) se unen Spider-Gwen y Nova del Tierra-65 - Byron Ornelas (tierra-65)
* | 5ae8eb6 - (hace 46 minutos) se une Scarlet Witch - Byron Ornelas
* | 815d1e1 - (hace 2 semanas) se retiran los heroes de Tierra-99999 - Byron Ornelas
|/  
*   5f7eb20 - (hace 2 semanas) incorporacion de Black Panther (T-7642) al equipo principal - Byron Ornelas
|\  
