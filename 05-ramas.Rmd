...
```
```{bash eval=F}
* c20b80d - (hace 4 minutos) .gitignore actualizado (extension .log) - Byron Ornelas (HEAD -> tierra-99999, main)
* 2ed8cf4 - (hace 5 minutos) .gitignore agregado - Byron Ornelas
* c9ffd15 - (hace 10 minutos) sin saignaciones para Spider-Man - Byron Ornelas
* e31eae6 - (hace 14 minutos) misiones de Spider-Man completadas - Byron Ornelas
* 0059540 - (hace 15 minutos) contactos.md eliminado - Byron Ornelas
* 2d05f6e - (hace 18 minutos) contactos.md renombrado - Byron Ornelas
* 1c7fe32 - (hace 19 minutos) contactos de emergencia agregados - Byron Ornelas
* 8727c32 - (hace 26 minutos) se unen Doctor Strange y Daredevil - Byron Ornelas
* a2427e8 - (hace 43 minutos) misiones/ agregado -> misiones de los heroes: iron man, thor, hulk, black widow y spider man. - Byron Ornelas
* 43b3a69 - (hace 44 minutos) debilidades.md agregado - Byron Ornelas
* c691147 - (hace 44 minutos) origenes.md agregado - Byron Ornelas
* ec89c02 - (hace 45 minutos) descripciones.md agregado - Byron Ornelas
* ac02fe0 - (hace 45 minutos) README.md agregado - Byron Ornelas%
```
...
```
```{bash eval=F}
* 6976c5a - (hace 26 segundos) se unen Captain marvel y Doctor Doom de Tierra-99999 - Byron Ornelas (HEAD -> tierra-99999)
* c20b80d - (hace 8 minutos) .gitignore actualizado (extension .log) - Byron Ornelas (main)
* 2ed8cf4 - (hace 10 minutos) .gitignore agregado - Byron Ornelas
* c9ffd15 - (hace 14 minutos) sin saignaciones para Spider-Man - Byron Ornelas
* e31eae6 - (hace 19 minutos) misiones de Spider-Man completadas - Byron Ornelas
* 0059540 - (hace 19 minutos) contactos.md eliminado - Byron Ornelas
* 2d05f6e - (hace 22 minutos) contactos.md renombrado - Byron Ornelas
* 1c7fe32 - (hace 23 minutos) contactos de emergencia agregados - Byron Ornelas
* 8727c32 - (hace 30 minutos) se unen Doctor Strange y Daredevil - Byron Ornelas
* a2427e8 - (hace 48 minutos) misiones/ agregado -> misiones de los heroes: iron man, thor, hulk, black widow y spider man. - Byron Ornelas
* 43b3a69 - (hace 48 minutos) debilidades.md agregado - Byron Ornelas
* c691147 - (hace 49 minutos) origenes.md agregado - Byron Ornelas
* ec89c02 - (hace 49 minutos) descripciones.md agregado - Byron Ornelas
* ac02fe0 - (hace 50 minutos) README.md agregado - Byron Ornelas%        
```
...
```
```{bash eval=F}
* f5907d1 - (hace 18 segundos) se une Scarlet Witch de Tierra-99999; se termina el registro de T-99999 - Byron Ornelas (HEAD -> tierra-99999)
* 6976c5a - (hace 5 minutos) se unen Captain marvel y Doctor Doom de Tierra-99999 - Byron Ornelas
* c20b80d - (hace 12 minutos) .gitignore actualizado (extension .log) - Byron Ornelas (main)
* 2ed8cf4 - (hace 14 minutos) .gitignore agregado - Byron Ornelas
* c9ffd15 - (hace 18 minutos) sin saignaciones para Spider-Man - Byron Ornelas
* e31eae6 - (hace 23 minutos) misiones de Spider-Man completadas - Byron Ornelas
* 0059540 - (hace 23 minutos) contactos.md eliminado - Byron Ornelas
* 2d05f6e - (hace 26 minutos) contactos.md renombrado - Byron Ornelas
* 1c7fe32 - (hace 27 minutos) contactos de emergencia agregados - Byron Ornelas
* 8727c32 - (hace 34 minutos) se unen Doctor Strange y Daredevil - Byron Ornelas
* a2427e8 - (hace 52 minutos) misiones/ agregado -> misiones de los heroes: iron man, thor, hulk, black widow y spider man. - Byron Ornelas
* 43b3a69 - (hace 52 minutos) debilidades.md agregado - Byron Ornelas
* c691147 - (hace 53 minutos) origenes.md agregado - Byron Ornelas
* ec89c02 - (hace 53 minutos) descripciones.md agregado - Byron Ornelas
* ac02fe0 - (hace 54 minutos) README.md agregado - Byron Ornelas%   
```
...
```
```{bash eval=F}
* f5907d1 - (hace 85 segundos) se une Scarlet Witch de Tierra-99999; se termina el registro de T-99999 - Byron Ornelas (HEAD -> main, tierra-99999)
* 6976c5a - (hace 6 minutos) se unen Captain marvel y Doctor Doom de Tierra-99999 - Byron Ornelas
* c20b80d - (hace 13 minutos) .gitignore actualizado (extension .log) - Byron Ornelas
* 2ed8cf4 - (hace 15 minutos) .gitignore agregado - Byron Ornelas
* c9ffd15 - (hace 19 minutos) sin saignaciones para Spider-Man - Byron Ornelas
* e31eae6 - (hace 24 minutos) misiones de Spider-Man completadas - Byron Ornelas
* 0059540 - (hace 24 minutos) contactos.md eliminado - Byron Ornelas
* 2d05f6e - (hace 28 minutos) contactos.md renombrado - Byron Ornelas
* 1c7fe32 - (hace 28 minutos) contactos de emergencia agregados - Byron Ornelas
* 8727c32 - (hace 36 minutos) se unen Doctor Strange y Daredevil - Byron Ornelas
* a2427e8 - (hace 53 minutos) misiones/ agregado -> misiones de los heroes: iron man, thor, hulk, black widow y spider man. - Byron Ornelas
* 43b3a69 - (hace 53 minutos) debilidades.md agregado - Byron Ornelas
* c691147 - (hace 54 minutos) origenes.md agregado - Byron Ornelas
* ec89c02 - (hace 54 minutos) descripciones.md agregado - Byron Ornelas
* ac02fe0 - (hace 55 minutos) README.md agregado - Byron Ornelas%   
```
...
```
```{bash eval=F}
*   5f7eb20 - (hace 3 minutos) incorporacion de Black Panther (T-7642) al equipo principal - Byron Ornelas (HEAD -> main)
|\  
| * 347dd3f - (hace 16 minutos) se une Black Panther de Tierra-7642; registro completo - Byron Ornelas (tierra-7642)
* | bd81998 - (hace 4 minutos) se le asignan nuevas misiones a Spider-Man - Byron Ornelas
|/  
* f5907d1 - (hace 23 minutos) se une Scarlet Witch de Tierra-99999; se termina el registro de T-99999 - Byron Ornelas
* 6976c5a - (hace 27 minutos) se unen Captain marvel y Doctor Doom de Tierra-99999 - Byron Ornelas
* c20b80d - (hace 35 minutos) .gitignore actualizado (extension .log) - Byron Ornelas
* 2ed8cf4 - (hace 36 minutos) .gitignore agregado - Byron Ornelas
* c9ffd15 - (hace 41 minutos) sin saignaciones para Spider-Man - Byron Ornelas
* e31eae6 - (hace 45 minutos) misiones de Spider-Man completadas - Byron Ornelas
* 0059540 - (hace 46 minutos) contactos.md eliminado - Byron Ornelas
* 2d05f6e - (hace 49 minutos) contactos.md renombrado - Byron Ornelas
* 1c7fe32 - (hace 50 minutos) contactos de emergencia agregados - Byron Ornelas
* 8727c32 - (hace 57 minutos) se unen Doctor Strange y Daredevil - Byron Ornelas
* a2427e8 - (hace 74 minutos) misiones/ agregado -> misiones de los heroes: iron man, thor, hulk, black widow y spider man. - Byron Ornelas
* 43b3a69 - (hace 75 minutos) debilidades.md agregado - Byron Ornelas
* c691147 - (hace 75 minutos) origenes.md agregado - Byron Ornelas
* ec89c02 - (hace 76 minutos) descripciones.md agregado - Byron Ornelas
* ac02fe0 - (hace 76 minutos) README.md agregado - Byron Ornelas%     
```
...
```{bash eval=F}
* 5ae8eb6 - (hace 4 minutos) se une Scarlet Witch - Byron Ornelas (HEAD -> main)
* 815d1e1 - (hace 2 semanas) se retiran los heroes de Tierra-99999 - Byron Ornelas
| * edf50e5 - (hace 2 semanas) se unen Spider-Gwen y Nova del Tierra-65 - Byron Ornelas (tierra-65)
|/  
...
En resumen lo que se encuentra entre `<<<<<<< HEAD` y `=======` es el registro de la rama actual, mientras que entre `=======` y `>>>>>>> tierra-65` se encuentre el registro de la rama que entró en conflicto.
...
```
 ...
 Modificamos `problemas.md` dejando el siguiente contenido:
...
| * 3447252 - (hace 3 minutos) problemas.md modificado (numeros-2) - [Nombre de usuario] (tierra-65)
|/  
*   bb296da - (hace 10 minutos) implementacion de numeros abundantes en rama 'tierra-65' - [Nombre de usuario] 
|\  
| * e26e013 - (hace 16 minutos) caracteristicas-2 modificado (numeros abundantes agregados) - [Nombre de usuario] (tierra-65)
...
|\  
| * 3447252 - (hace 4 minutos) problemas.md modificado (numeros-2) - [Nombre de usuario] (tierra-65)
* | 74aca37 - (hace 7 minutos) problemas.md modificado - [Nombre de usuario]
|/  
*   bb296da - (hace 12 minutos) implementacion de numeros abundantes en rama 'tierra-65' - [Nombre de usuario]
|\  
...
14. Por último, eliminamos la rama `tierra-65`

```{bash eval=F}
git branch -d tierra-65
```
```{bash eval=F}
Eliminada la rama tierra-65 (era 3447252).
```
